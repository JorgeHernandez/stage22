...
class appProdProjectContainer__524435d857a4d__ extends Container
{
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), '/home/adminuser/webs/pro22/app/cache/prod_new/annotations', false);
    }
    ...
    protected function getAssetic_AssetManagerService()
    {
        ...
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('config' => new \Symfony\Bundle\AsseticBundle\Factory\Loader\ConfigurationLoader(), 'twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig')), new \Assetic\Cache\ConfigCache('/home/adminuser/webs/pro22/app/cache/prod_new/assetic/config'), false)));
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $g->setProxyDir('/home/adminuser/webs/pro22/app/cache/prod_new/doctrine/orm/Proxies');
    ...
    protected function getProfilerService()
    {
        ...
        $c->setKernel($b);
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage('file:/home/adminuser/webs/pro22/app/cache/prod_new/profiler', '', '', 86400), $a);
        $instance->disable();
        $instance->add($c);
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('/home/adminuser/webs/pro22/app/cache/prod_new/secure_random.seed', $this->get('monolog.logger.security'));
    }
    ...
    {
        return $this->services['session.handler'] = new \Symfony\Component\HttpFoundation\Session\Storage\Handler\NativeFileSessionHandler('/home/adminuser/webs/pro22/app/cache/prod_new/sessions');
    }
    protected function getSession_Storage_FilesystemService()
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('/home/adminuser/webs/pro22/app/cache/prod_new/sessions');
    }
    ...
    {
        $this->services['translator.default'] = $instance = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, new \Symfony\Component\Translation\MessageSelector(), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini')), array('cache_dir' => '/home/adminuser/webs/pro22/app/cache/prod_new/translations', 'debug' => false));
    ...
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => false, 'strict_variables' => false, 'exception_controller' => 'twig.controller.exception:showAction', 'cache' => '/home/adminuser/webs/pro22/app/cache/prod_new/twig', 'charset' => 'UTF-8', 'paths' => array()));
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), '/home/adminuser/webs/pro22/app/cache/prod_new');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.debug' => false,
            'kernel.name' => 'app',
            'kernel.cache_dir' => '/home/adminuser/webs/pro22/app/cache/prod_new',
            ...
            'kernel.container_class' => 'appProdProjectContainer__524435d857a4d__',
            ...
            'session.save_path' => '/home/adminuser/webs/pro22/app/cache/prod_new/sessions',
            ...
            'profiler.storage.dsn' => 'file:/home/adminuser/webs/pro22/app/cache/prod_new/profiler',
            ...
            'twig.options' => array(
                ...
                'cache' => '/home/adminuser/webs/pro22/app/cache/prod_new/twig',
                'charset' => 'UTF-8',
                'paths' => array(
                ),
            ),
            ...
            'assetic.cache_dir' => '/home/adminuser/webs/pro22/app/cache/prod_new/assetic',
            ...
            'doctrine.orm.proxy_dir' => '/home/adminuser/webs/pro22/app/cache/prod_new/doctrine/orm/Proxies',
