...
class __TwigTemplate_f8c7f1a5c89f28b43bca5df531baf1ed54b11ef8220b2f117b6747164e46e5d2 extends Twig_Template
{
    ...
    {
        // line 1
        echo "<div class=\"next-prev-projects\">
    <div class=\"next\">
        ";
        // line 3
        if ($this->getContext($context, "nextProject")) {
            // line 4
            echo "            <a href=\"";
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("portfolio_project_view", array("categorySlug" => $this->getAttribute($this->getContext($context, "category"), "slug"), "projectSlug" => $this->getAttribute($this->getContext($context, "nextProject"), "slug"))), "html", null, true);
            echo "\">
                ";
            // line 5
            echo twig_escape_filter($this->env, $this->env->getExtension('translator')->trans("Следующий проект"), "html", null, true);
            echo " →
            </a>
            <br />
            ";
            // line 8
            echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "nextProject"), "name"), "html", null, true);
            echo "
        ";
        } else {
            // line 10
    ...
    <div class=\"prev\">
        ";
        // line 15
        if ($this->getContext($context, "previousProject")) {
            // line 16
            echo "            <a href=\"";
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("portfolio_project_view", array("categorySlug" => $this->getAttribute($this->getContext($context, "category"), "slug"), "projectSlug" => $this->getAttribute($this->getContext($context, "previousProject"), "slug"))), "html", null, true);
            echo "\">
                ← ";
            // line 17
            echo twig_escape_filter($this->env, $this->env->getExtension('translator')->trans("Предыдущий проект"), "html", null, true);
            echo "
            </a>
            <br />
            ";
            // line 20
            echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "previousProject"), "name"), "html", null, true);
            echo "
        ";
        } else {
            // line 22
    ...
    {
        return "StfalconPortfolioBundle:Project:nearbyProjects.html.twig";
    }
