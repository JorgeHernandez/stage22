...
class __TwigTemplate_4e5fe6a66582ada23070c85bbd4e073ab70a5cf614148078b5054f8139ad37b6 extends Twig_Template
{
    ...
    ";
        ...
        ";
        // line 22
        echo $this->env->getExtension('actions')->renderUri($this->env->getExtension('http_kernel')->controller("StfalconBlogBundle:Post:last", array("count" => 7)), array());
        // line 23
        echo "        <a href=\"";
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("blog"), "html", null, true);
        echo "\" class=\"all-posts\">все статьи</a>
    </div>
    ...
    {
        return "ApplicationDefaultBundle:Default:_shared.html.twig";
    }
