...
class __TwigTemplate_c746e1f27b6d6c6a78b71f516a8b715f7d82bae89941b3752e5566db7877b9b4 extends Twig_Template
{
        ...
        \$(document).ready(function() {
            \$(\".content table tbody\").sortable({
                ...
                update: function(event, ui) {
                    ...
                    \$.post('";
        // line 19
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("portfolioProjectsApplyOrder"), "html", null, true);
        echo "', {projects: array}, function(response){});
                }
            }).disableSelection();
        });
    </script>
";
    ...
    {
        return "StfalconPortfolioBundle:ProjectAdmin:list.html.twig";
    }
