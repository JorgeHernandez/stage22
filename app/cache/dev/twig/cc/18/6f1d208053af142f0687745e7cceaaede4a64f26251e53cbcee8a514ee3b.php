...
class __TwigTemplate_cc186f1d208053af142f0687745e7cceaaede4a64f26251e53cbcee8a514ee3b extends Twig_Template
{
    ...
    ";
        ...
        if (array_key_exists("project", $context)) {
            // line 8
            echo "            ";
            if ($this->getAttribute($this->getContext($context, "project"), "users")) {
                // line 9
                echo "            <div class=\"users-list\">
                <h2>";
                // line 10
                echo $this->env->getExtension('translator')->getTranslator()->trans("Над проектом работали", array(), "messages");
                echo "</h2>
                ";
                // line 11
                echo $this->getAttribute($this->getContext($context, "project"), "users");
                echo "
            </div>
            ";
            }
