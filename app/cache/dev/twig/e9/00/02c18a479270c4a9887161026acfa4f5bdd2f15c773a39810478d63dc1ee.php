...
/* StfalconBlogBundle:Post:_posts.html.twig */
class __TwigTemplate_e90002c18a479270c4a9887161026acfa4f5bdd2f15c773a39810478d63dc1ee extends Twig_Template
{
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["post"]) {
            ...
            echo "</a>
                    ...
                    <p>
                        ";
            // line 11
            echo $this->env->getExtension('read_more')->cutMore($this->getAttribute($this->getContext($context, "post"), "textAsHtml"));
            echo "

                        ";
            // line 13
            if ($this->env->getExtension('read_more')->hasMore($this->getAttribute($this->getContext($context, "post"), "text"))) {
                // line 14
                echo "                            <a href=\"";
                echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("blog_post_view", array("slug" => $this->getAttribute($this->getContext($context, "post"), "slug"))), "html", null, true);
                echo "#more\">
                                ";
                // line 15
                echo twig_escape_filter($this->env, $this->env->getExtension('translator')->trans("Читать далее"), "html", null, true);
                echo " →
                            </a>
                        ";
            }
            ...
            echo "                    </p>
                ...
                ";
            // line 20
            $this->env->loadTemplate("StfalconBlogBundle:Post:_post_info.html.twig")->display(array_merge($context, array("post" => $this->getContext($context, "post"))));
            // line 21
            echo "            </div>
        </li>
    ";
    ...
    {
        return "StfalconBlogBundle:Post:_posts.html.twig";
    }
