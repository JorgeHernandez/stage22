...
/* StfalconBlogBundle:Post:view.html.twig */
class __TwigTemplate_3e02568dbcf5e7addb3998fe4ff17cd613679b169b22d415b8ef882e3c6f00f4 extends Twig_Template
{
    public function __construct(Twig_Environment $env)
    {
        parent::__construct($env);

        $this->parent = $this->env->loadTemplate("StfalconBlogBundle::layout.html.twig");
    ...
    public function block_title($context, array $blocks = array())
    {
        ...
        echo " / ";
        echo $this->env->getExtension('translator')->getTranslator()->trans("Блог", array(), "messages");
        echo " / ";
    ...
    public function block_content($context, array $blocks = array())
    {
        ...
        echo "
            ...
            <p>
                ";
        // line 13
        echo $this->env->getExtension('read_more')->moreToSpan($this->getAttribute($this->getContext($context, "post"), "textAsHtml"));
        echo "
            </p>
        </div>
        ...
        ";
        // line 17
        $this->env->loadTemplate("StfalconBlogBundle:Post:_post_info.html.twig")->display(array_merge($context, array("post" => $this->getContext($context, "post"), "share_buttons" => true)));
        // line 18
        echo "
        <p>
        ...
        // line 24
        echo twig_escape_filter($this->env, $this->getContext($context, "disqus_shortname"), "html", null, true);
        echo "';
        ...
        echo "';
            var disqus_url = '";
        // line 26
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getUrl("blog_post_view", array("slug" => $this->getAttribute($this->getContext($context, "post"), "slug"))), "html", null, true);
        echo "';
            var disqus_title = '";
        // line 27
        echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "post"), "title"), "html", null, true);
        echo "';   
            ...
            function disqus_config() {
                this.callbacks.onNewComment = [function() {
                    \$.ajax({  url: '";
        // line 39
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getUrl("blog_post_disqus_sync", array("slug" => $this->getAttribute($this->getContext($context, "post"), "slug"))), "html", null, true);
        echo "' });
                }];
            }
        </script>
...
";
    ...
    {
        return "StfalconBlogBundle:Post:view.html.twig";
    }
